...
public class KafkaReadTxtTest {
    private static final Logger logger = LoggerFactory.getLogger(KafkaReadTxtTest.class); 
...
//    private static String zooKeeper = "192.168.2.183:2181,192.168.2.108:2181,192.168.2.182:2181";
	...
	public static void main(String[] args) throws InterruptedException, IOException {
        ...
        BufferedReader reader=new BufferedReader(new FileReader("c:\\1030uasn.txt"));
